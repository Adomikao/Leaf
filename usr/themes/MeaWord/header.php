...
<head>
    ...
    <title>Leaf | 余永健</title>
    <?php else: ?>
    <title><?php $this->title() ?> - Leaf | 余永健 </title>
    <?php endif; ?>
    <?php $this->header(); ?>
    <meta name="HandheldFriendly" content="True" /> 
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
	<link rel="shortcut icon" href="<?php echo empty($this->options->logo)?'//wx1.sinaimg.cn/mw690/0072WRWsly1g0u4z5187kj305p05pwes.jpg':$this->options->logo;?>">
